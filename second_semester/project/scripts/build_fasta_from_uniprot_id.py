#this script takes as input a list of Uniprot IDs and a fasta file of Uniprot sequences, and outputs a fasta file of the input IDs associated with their sequence
...
def create_id_list(id_file):
    ...
    for line in f:
        ...
        if uniprot_id != ['']:              #avoid appending empty elements to the ID list
